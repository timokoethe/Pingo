...
const paragraphClassName = "mt-4 text-sm leading-7 text-foreground-muted";
const linkClassName =
  "font-medium text-foreground-strong underline decoration-black/20 underline-offset-4 hover:decoration-foreground-strong";
